...
== Administra un sistema de archivos usando NetApp Workload Factory

Cuando abres un sistema FSx para ONTAP desde la página de sistemas de la NetApp Console, vas a NetApp Workload Factory. NetApp Workload Factory es un servicio inteligente de optimización y automatización que utiliza las mejores prácticas del sector para planificar, aprovisionar y operar cargas de trabajo clave usando Amazon FSx for NetApp ONTAP.

https://docs.netapp.com/us-en/workload-fsx-ontap/index.html["Aprende a gestionar un sistema de archivos usando NetApp Workload Factory"^]
